                                ...
                                <tbody>
                                    @foreach ($orderItems as $item)
                                        <tr>
                                            ...
                                            <td class="pname">
                                                <div class="image">
                                                    <img src="{{ asset('uploads/products/thumbnalis') }}/{{$item->product->image}}" alt="{{$item->product->name}}"
                                                        class="image">
                                                </div>
                                                <div class="name">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($transaction->status == 'approved')
                                            <span class="bage bg-success">
                                                Approved
                                            </span>
                                        @elseif($transaction->status == 'declinded')
                                            <span class="bage bg-danger">
                                                Declinde
                                            </span>
