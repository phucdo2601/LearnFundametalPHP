                                    ...
                                    <tr>
                                        <td>
                                            <div class="shopping-cart__product-item">
                                                <img loading="lazy"
                                                    src="{{ asset('uploads/products/thumbnalis') }}//{{$item->model->image}}"
                        ...
                        <div class="cart-table-footer">
                            @if (!Session::has('coupon'))
                                <form action="{{ route('cart.coupon.apply') }}" method="POST" class="position-relative bg-body">
                                    @csrf
                                    <input class="form-control" style="margin-right: 50px;" type="text" name="coupon_code"
                                        placeholder="Coupon Code" value="@if (Session::has('coupon'))
                                            {{Session::get('coupon')['code']}} Applied!
                                        @endif" />
                                ...
                                @if (Session::has('discounts'))
                                    <table class="cart-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Subtotal After Discount {{Session::get('coupon')['code']}}</th>
