...
<body>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" value="<?= $student['id']; ?>" class="viewStudentBtn btn btn-info">
                                                    View
                                                </button>
                                                <button type="button" value="<?= $student['id']; ?>" class="editStudentBtn btn btn-success">
                                                    Edit
                                                </button>
                                                <button type="button" value="<?= $student['id']; ?>" class="deleteStudentBtn btn btn-danger">
                                                    Delete
                                                </button>
    ...
    <script>
        ...
        $(document).on('click', '.editStudentBtn', function() {
            ...
            $.ajax({
                type: "GET",
                url: "code.php?student_id=" + studentId,
                success: function(response) {
                    var res = jQuery.parseJSON(response);
                    if (res.status === 422) {
                        alert(res.message);
